    ...
    },
    {
      ...
      renderCell: (params: { row: Item }) => (
        <div className={styles.actions}>
          ...
          >
            {params.row.disabled ? (
              <VisibilityOff className={styles.icon} sx={{ color: isAdmin ? "blue" : "gray" }} />
            ) : (
              <Visibility className={styles.icon} sx={{ color: isAdmin ? "blue" : "gray" }} />
            )}
          </IconButton>
          <IconButton
          ...
          >
            <Delete className={styles.icon} sx={{ color:isAdmin ?  "red" : "gray" }} />
          </IconButton>
        </div>
      ),
      sortable: false,
